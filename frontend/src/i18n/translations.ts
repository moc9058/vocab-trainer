const translations = {
  en: {
    ...
    translationGrammarBreakdown: "Grammar Breakdown",
    translationKeyVocabulary: "Key Vocabulary",
    translationAlternatives: "Alternative Expressions",
    translationCulturalNotes: "Cultural Notes",
  ...
  ja: {
    ...
    translationGrammarBreakdown: "文法分析",
    translationKeyVocabulary: "重要語彙",
    translationAlternatives: "別の表現",
    translationCulturalNotes: "文化メモ",
    clearHistory: "履歴を削除",
  ...
  ko: {
    ...
    regenerate: "재생성",
    newTranslation: "새 번역",
    translationGrammarBreakdown: "문법 분석",
    translationKeyVocabulary: "핵심 어휘",
    translationAlternatives: "대안 표현",
    translationCulturalNotes: "문화 노트",
    clearHistory: "기록 삭제",
